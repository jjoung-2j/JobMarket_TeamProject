...
public class Recruit_apply_DAO_imple implements Recruit_apply_DAO {
   ...
   private void close() {
	...
	// ◆◆◆ === 채용공고 조회 === ◆◆◆ //
	@Override
	public void recruit_search(Scanner sc, User_DTO user, Company_DTO company) {
		// TODO Auto-generated method stub
		
	}	// end of public void recruit_search(Scanner sc, User_DTO user, Company_DTO company, Recruit_INFO_DTO recruit)----
    ...
    public Company_DTO company_search(Map<String, String> paraMap) {
		...
		try {
         String sql = " select A.company_name, B.begin_day ,A.ceo_name, B.company_type, A.company_address "
                  + "      , B.employee_num "
